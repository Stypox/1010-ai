...
void parseArguments(int argc, char const* argv[], bool& noUi, ai::scoring_table_t& scoringTable) {
	...
	stypox::ArgParser argParser{
		std::make_tuple(
			...
			stypox::ManualOption{"scoring table", scoringTable, stypox::args("-fpst=", "--fitting-pieces-scoring-table="), "a scoring table, enables FittingPiecesScoringFunction (possible values: full, fast, custom)",
